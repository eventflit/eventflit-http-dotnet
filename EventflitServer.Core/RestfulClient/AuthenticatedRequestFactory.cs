...
{
    /// <summary>
    /// Factory that creates authenticated requests to send to the Eventflit API
    /// </summary>
    public class AuthenticatedRequestFactory : IAuthenticatedRequestFactory
    {
        ...
        /// </summary>
        /// <param name="appKey">Your app Key for the Eventflit API</param>
        /// <param name="appId">Your app Id for the Eventflit API</param>
        /// <param name="appSecret">Your app Secret for the Eventflit API</param>
        ...
        /// <inheritdoc/>
        public IEventflitRestRequest Build(EventflitMethod requestType, string resource, object requestParameters = null, object requestBody = null)
        {
            ...
            IEventflitRestRequest request = new EventflitRestRequest(requestUrl);
