...
namespace EventflitServer
{
    ...
    public interface IEventflit
    {
        ...
        /// <summary>
        /// Queries the Eventflit API for the Users of a Presence Channel asynchronously
        /// </summary>
        ...
        /// <summary>
        /// Asynchronously queries the Eventflit API for the state of a Channel
        /// </summary>
        /// <typeparam name="T">The type of object that will be returned by the API</typeparam>
        /// <param name="channelName">The name of the channel to query</param>
        ...
        /// <summary>
        /// Queries the Eventflit API for the state of all channels based upon the info object
        /// </summary>
        /// <typeparam name="T">The type of object that will be returned by the API</typeparam>
        /// <param name="info">An object containing a list of attributes to include in the query</param>
