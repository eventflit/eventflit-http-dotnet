...
namespace EventflitServer.Tests.UnitTests
{
    ...
    public class When_authenticating_a_private_channel
    {
        ...
        public void Setup()
        {
            _eventflit = new Eventflit(Config.AppId, Config.AppKey, Config.AppSecret);
        }
        ...
        public void the_auth_response_is_valid()
        {
            ...
            IAuthenticationData result = _eventflit.Authenticate(channelName, socketId);
        ...
        {
            _eventflit.Authenticate("private-test", ":444.444");
        }
        ...
        {
            _eventflit.Authenticate("private-test", "444.444a");
        }
        ...
        {
            _eventflit.Authenticate("private-test", "444");
        }
        ...
        {
            _eventflit.Authenticate("private-test", "\n444.444");
        }
        ...
        {
            _eventflit.Authenticate("private-test", string.Empty);
        }
        ...
        {
            _eventflit.Authenticate(channelName, "123.456");
        }
    ...
    public class When_authenticating_a_presence_channel
    {
        ...
        public void null_presence_data_throw_Exception()
        {
            ...
            _eventflit.Authenticate(channelName, socketId, null);
        }
        ...
        public void the_auth_response_is_valid()
        {
            ...
            IAuthenticationData result = _eventflit.Authenticate(channelName, socketId, data);
            Assert.AreEqual(expectedAuthString, result.auth);
        }
